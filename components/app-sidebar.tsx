...
export function AppSidebar() {
  ...
  const navigationItems = [
    ...
    
    {
      icon: User,
      label: "Profile",
href: user ? `/profile/${user.username}` : "/not-found"    }
  ];
        ...
        <div className="flex flex-col h-full p-8">
          ...
          <div className="mt-auto pt-6 border-t border-border/50 space-y-6">
              ...
              <UserButton
                ...
                appearance={{
                  elements: {
                    ...
                    userButtonTrigger:
                      "w-full flex items-center gap-4 px-6 py-4 rounded-2xl hover:bg-muted/50",
            ...
            <SignedOut>
              <Link
                href="/sign-in"
                className="group flex items-center gap-4 px-6 py-4 rounded-2xl transition-colors hover-lift hover:bg-muted/50 text-muted-foreground hover:text-foreground"
              >
