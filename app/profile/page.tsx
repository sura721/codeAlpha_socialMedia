...
import { type User, initializeMockData } from "@/lib/mock-data"
...
const posts = [
  ...
  { id: 7, image: "/placeholder.svg?height=200&width=200" },
  { id: 8, image: "/placeholder.svg?height=200&width=200" },
  { id: 9, image: "/placeholder.svg?height=200&width=200" },
]
...
export default function ProfilePage() {
  ...
  const loadUserData = () => {
    ...
    if (currentUser) {
      setUser(currentUser)
      setFollowers(DataService.getFollowers(currentUser.id))
      setFollowing(DataService.getFollowing(currentUser.id))

      const allPosts = DataService.getPostsWithAuthors()
  ...
  return (
    <>
              ...
              <div className="flex flex-col lg:flex-row lg:items-end gap-6">
                <div className="relative">
                  <Avatar className="h-40 w-40 ring-8 ring-white dark:ring-gray-900 shadow-2xl">
                    <AvatarImage src={user.image || "/placeholder.svg?height=160&width=160"} />
                ...
                <div className="flex-1 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl">
                  ...
                  {/* Stats - Fixed alignment with flexbox baseline */}
                  <div className="flex items-baseline justify-start gap-8">
                    <div className="flex flex-col items-center">
                      <p className="text-3xl font-bold text-gradient leading-none">{userPosts.length}</p>
          ...
          <div className="relative">
            ...
            <div className="relative -mt-12 px-6">
              <div className="flex flex-col items-center text-center">
                ...
                {/* Mobile Stats - Fixed alignment with flexbox baseline */}
                <div className="flex items-baseline justify-center gap-8 mb-8">
                  <div className="flex flex-col items-center">
                    <p className="text-2xl font-bold text-gradient leading-none">{userPosts.length}</p>
                  ...
                  >
                    <p className="text-2xl font-bold text-gradient leading-none">{followers.length}</p>
                  ...
                  <Link
                    ...
                    className="flex flex-col items-center hover:bg-muted/50 rounded-xl p-3 transition-colors"
                  >
                    <p className="text-2xl font-bold text-gradient leading-none">{following.length}</p>
      ...
      <EditProfileModal open={editModalOpen} onOpenChange={setEditModalOpen} user={user} onUpdate={handleUserUpdate} />
    </>
  )
}
